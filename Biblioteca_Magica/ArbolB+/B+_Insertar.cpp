...
ArbolBPlus::~ArbolBPlus() {
    try {
        ...
        std::cerr << "Error en ArbolBPlus::~ArbolBPlus: " << e.what() << std::endl;
    }
}
...
void ArbolBPlus::liberarRecursivo(NodoBPlus* nodo) {
    ...
    try {
        ...
        std::cerr << "Error en ArbolBPlus::liberarRecursivo: " << e.what() << std::endl;
        throw;
    }
}
...
void ArbolBPlus::insertarSoloGenero(const std::string &genero) {
    try {
        ...
        std::cerr << "Error en ArbolBPlus::insertarSoloGenero: " << e.what() << std::endl;
    }
}
...
NodoHoja* ArbolBPlus::buscarHoja(const std::string& genero) const {
    try {
        ...
        while (!nodo->esHoja) {
            ...
            if (i > interno->numClaves || !interno->hijos[i]) {
                throw std::runtime_error("Hijo nulo o índice inválido en buscarHoja");
            }
        ...
        std::cerr << "Error en ArbolBPlus::buscarHoja: " << e.what() << std::endl;
        return nullptr;
    }
}
...
void ArbolBPlus::insertarEnHoja(NodoHoja* hoja, Libro* libro) {
    try {
        ...
        std::cerr << "Error en ArbolBPlus::insertarEnHoja: " << e.what() << std::endl;
        throw;
    }
}
...
void ArbolBPlus::dividirHoja(NodoHoja* hoja) {
    try {
        ...
        std::cerr << "Error en ArbolBPlus::dividirHoja: " << e.what() << std::endl;
        throw;
    }
}
...
void ArbolBPlus::dividirInterno(NodoInterno* interno) {
    try {
        if (!interno) throw std::invalid_argument("Nodo interno nulo en dividirInterno");
        ...
        std::cerr << "Error en ArbolBPlus::dividirInterno: " << e.what() << std::endl;
        throw;
    }
}
...
NodoInterno* ArbolBPlus::buscarPadre(NodoBPlus* actual, NodoBPlus* hijo) const {
    try {
        ...
        std::cerr << "Error en ArbolBPlus::buscarPadre: " << e.what() << std::endl;
        return nullptr;
    }
}
...
void ArbolBPlus::insertarLibroEnGenero(Libro *libro) {
    try {
        ...
        std::cerr << "Error en ArbolBPlus::insertarLibroEnGenero: " << e.what() << std::endl;
    }
}